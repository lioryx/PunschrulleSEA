...
function Punsch_Mirror_OnEvent()
	if (event == "MIRROR_TIMER_START") then
		...
		--arg6 label
		if debugMirror then
			DEFAULT_CHAT_FRAME:AddMessage("MIRROR_TIMER_START " ..
		...
		PunschMirrorEvents[arg1].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"][arg1]
				.label
	...
	elseif (event == "PLAYER_CAMPING") then
		...
		PunschMirrorEvents["CAMP"].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]
				["CAMP"].label
	...
	elseif (event == "PLAYER_QUITING") then
		...
		PunschMirrorEvents["QUIT"].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]
				["QUIT"].label
	...
	elseif (event == "INSTANCE_BOOT_START") then
		...
		PunschMirrorEvents["BOOT"].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]
				["BOOT"].label
	...
	elseif (event == "CONFIRM_SUMMON") then
		...
		PunschMirrorEvents["SUMMON"].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]
				["SUMMON"].label
	...
	elseif (event == "CHAT_MSG_BG_SYSTEM_NEUTRAL") then
		...
		if strfind(arg1, "1 minute") then
			PunschMirrorEvents["GAMESTART"].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]
					["GAMESTART"].label
	...
	elseif (event == "CHAT_MSG_BG_SYSTEM_ALLIANCE") or (event == "CHAT_MSG_BG_SYSTEM_HORDE") then
		if strfind(arg1, "(%S+) captured the (%S+) flag!") then
			...
			PunschMirrorEvents["WSG_FLAGRESPAWN"].label = PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]
					["Events"]["WSG_FLAGRESPAWN"].label
