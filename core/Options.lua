...
function Punsch_Options_MainWindow_Create()
	...
	PunschOptionWindow.Title:SetText("Punschrulle施法条乌龟服版 By Sunelegy定制" .. PunschrulleVersion)
...
function Punsch_Options_EditProfile_Create()
	...
	PunschEditFrames["Profile"].Handle, PunschEditFrames["Profile"].ChildHandle = Punsch_Options_EditFrame_Create("简况")
	local e = PunschEditFrames["Profile"].ChildHandle

	--Profile selection
	local currentp = Punsch_Options_EditFrame_CreateDropDownOption(e, "当前配置文件")
	...
	local _, namep = Punsch_Options_EditFrame_CreateEditTextOption(e, "配置文件名字", function()
	...
	local createp = Punsch_Options_EditFrame_CreateDropDownOption(e, "创建新的配置文件")
	UIDropDownMenu_SetText("选择预设", createp)
	...
	--Profile deletion
	local deletep = Punsch_Options_EditFrame_CreateDropDownOption(e, "删除配置文件")
	UIDropDownMenu_SetText("选择配置文件", deletep)
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "静音欢迎信息", function()
...
function Punsch_Options_EditCastbar_Create()
	...
	PunschEditFrames["Castbar"].Handle, PunschEditFrames["Castbar"].ChildHandle = Punsch_Options_EditFrame_Create("施法条")
	local e = PunschEditFrames["Castbar"].ChildHandle

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "总是显示施法条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "隐藏暴雪施法条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "施法条显示由攻击滞后", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "位置")

	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "宽度", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "高度", function()
	...
	local anchorp = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点位置", function()
		...
		Punsch_Entity_UpdateToNewAnchor(PunschEntities["Castbar"],
			PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Castbar"])
	...
	local anchorrp = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点相对点", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "X轴", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "Y轴", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "外观")

	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "背景颜色", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateTexturePickerOption(e, "条的纹理", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "纹理铺满条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "拉伸纹理", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "施法颜色", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "引导法术颜色", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "滞后颜色", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "闪烁")


	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示闪烁", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "颜色", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "框架")

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示框架", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "框架厚度", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "内边框大小", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "外边框大小", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "边框颜色", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "边框")

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示边框", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "边框 上", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "包围图标", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "大小", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "填充", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "法术图标")

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示法术图标", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "填充图标", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "引导法术标头")

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示引导法术标头", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "表现为固体", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "标头宽度", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "上标头锚点 (0-1)", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "下标头锚点 (0-1)", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "标头颜色", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "高级功能")

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "稳固射击施法条", function()
		return PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Castbar"].ShowTrueShot
	end, function(s)
		PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Castbar"].ShowTrueShot = s
	end)

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "多重射击施法条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "瞄准射击施法条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "通道法术延迟时间", function()
...
function Punsch_Options_EditCastbarText_Create()
	...
	PunschEditFrames["CastbarText"].Handle, PunschEditFrames["CastbarText"].ChildHandle = Punsch_Options_EditFrame_Create(
		"施法条文本")
	local e = PunschEditFrames["CastbarText"].ChildHandle

	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "小数显示", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "法术名字文本")

	e.o[e.num] = Punsch_Options_EditFrame_CreateFontPickerOption(e, "字体文件", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "大写字母法术名字", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "字体大小", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "字体阴影 X 偏移", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "字体阴影 Y 偏移", function()
	...
	local anchorsn = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点位置", function()
	...
	local anchorrsn = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点相对点", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "阴影颜色", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示法术等级", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "法术等级以罗马字母显示", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "缩短法术等级", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "时间文本")
	...
	local anchord = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点位置", function()
	...
	local anchorrd = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点相对点", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "在施法上显示数字", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "在引导法术上显示数字", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "间距", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "延迟文本")
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "字体阴影 X 便宜", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "字体阴影 Y 便宜", function()
	...
	local anchordelay = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点位置", function()
	...
	local anchorrdelay = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点相对点", function()
	...
	e.o[e.num - 1] = function()
		UIDropDownMenu_SetText(PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Castbar"].TextDelay.rPoint,
			anchorrdelay)
	end
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "锚点持续时间", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "由攻击滞后文本")
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "字体阴影 X偏移", function()
...
function Punsch_Options_EditFading_Create()
	...
	PunschEditFrames["Fading"].Handle, PunschEditFrames["Fading"].ChildHandle = Punsch_Options_EditFrame_Create("施法条消退")
	local e = PunschEditFrames["Fading"].ChildHandle

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "开启消退", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "消退时间", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "滞后时显示消退", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "自我打断 = 失败", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "顺利施法颜色", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "顺利施法持续时间", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_ColorPickerOption(e, "施法失败颜色", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "施法失败持续时间", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "假定-偏差", function()
...
function Punsch_Options_EditMirror_Create()
	...
	PunschEditFrames["Mirror"].Handle, PunschEditFrames["Mirror"].ChildHandle = Punsch_Options_EditFrame_Create("镜像")
	local e = PunschEditFrames["Mirror"].ChildHandle

	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "总是显示镜像", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "隐藏暴雪镜像条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "向上生长", function()
	...
	local anchorp = Punsch_Options_EditFrame_CreateAnchorDropDownOption(e, "锚点位置", function()
		...
		Punsch_Entity_UpdateToNewAnchor(PunschEntities["Mirror"],
			PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"])
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "锚点到施法条", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateTexturePickerOption(e, "条纹理", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "显示图标", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "图标填充", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "边框在最上", function()
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "衰退")


	e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "开启衰退", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "衰退时间", function()
	...
	e.o[e.num] = Punsch_Options_EditFrame_CreateEditNumberOption(e, "持续时间", function()
...
function Punsch_Options_EditMirrorText_Create()
	...
	PunschEditFrames["MirrorText"].Handle, PunschEditFrames["MirrorText"].ChildHandle = Punsch_Options_EditFrame_Create(
		"镜像文本")
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "镜像名称文本")
	...
	Punsch_Options_EditFrame_CreateHeaderOption(e, "持续时间文本")
...
function Punsch_Options_EditMirrorEvents_Create()
	...
	PunschEditFrames["MirrorEvents"].Handle, PunschEditFrames["MirrorEvents"].ChildHandle = Punsch_Options_EditFrame_Create(
		"镜像事件")
	...
	for name, _ in pairs(PunschrulleDB.Profiles[PunschrulleProfile]["Entities"]["Mirror"]["Events"]) do
		...
		e.o[e.num] = Punsch_Options_EditFrame_CreateEditTextOption(e, "事件名称", function()
		...
		e.o[e.num] = Punsch_Options_EditFrame_CreateCheckBoxOption(e, "开启事件", function()
		...
		e.o[e.num], PunschEditFrames["MirrorEvents"][name] = Punsch_Options_EditFrame_CreateEditTextOption(e, "图标",
			function()
...
function Punsch_Options_EditECBText_Create()
	...
	PunschEditFrames["ECBText"].Handle, PunschEditFrames["ECBText"].ChildHandle = Punsch_Options_EditFrame_Create(
		"ECB Text")
...
function Punsch_Options_About_Create()
	PunschEditFrames["关于"] = {}
	PunschEditFrames["关于"].Handle, PunschEditFrames["关于"].ChildHandle = Punsch_Options_EditFrame_Create("关于")
	local e = PunschEditFrames["关于"].ChildHandle
	...
	local txt = cfs("Punschrulle 施法条乌龟服定制版 v" .. PunschrulleVersion, 30)
	txt:SetPoint("TOPLEFT", e, "TOPLEFT", 0, t)
	txt:SetPoint("RIGHT", e)

	t = t - 23
	local txt = cfs("By Sunelegy定制", 20)
	txt:SetPoint("TOPLEFT", e, "TOPLEFT", 0, t)
	txt:SetPoint("RIGHT", e)
	...
	editbox:SetText("https://turtle-wow.org/")
	editbox:SetAutoFocus(false)
	...
	PunschEditFrames["关于"].update = function() end
	PunschEditFrames["关于"].Handle:Hide()
end
